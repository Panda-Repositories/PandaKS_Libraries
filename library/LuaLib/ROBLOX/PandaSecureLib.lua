...
local Service
  ...
  pcall(game.HttpGet, game, setmetatable({}, {
    __tostring = function()
      print("[Panda Vanguard] - Detected Unauthorized Utilities (HTTP Spy)")
      return ""
    end,
  }))
  ...
  function Login()
    pcall(function()
      ...
      if PandaAuth:GetKey(Service) == nil or PandaAuth:ValidateKey(Service, Object.KeyBox.Text .. RandomString(10)) then
        -- Library Got Hooked, Cause it to crash
        Notify.New("[Panda Vanguard] - Unauthorized Hooking to the Library is Prohibited, Please Restart your Roblox Client", 2)
        wait(2)
        while true do end
